...
const TooltipContent = ({
  ...
  <BaseTooltip.Portal>
    <BaseTooltip.Positioner align={align} alignOffset={alignOffset} side={side} sideOffset={sideOffset} className="isolate z-50">
      <BaseTooltip.Popup ref={ref} className={cn(tooltipContentVariants({ variant, className }))} {...props} />
...
export { TooltipObject as Tooltip, TooltipProvider, TooltipTrigger, TooltipContent };
