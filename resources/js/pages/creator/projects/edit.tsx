...
import { MIN_TECH_STACK, PROJECT_TYPES, type Project } from './shared';

type PageProps = {
    project: Project;
};

export default function CreatorProjectEdit() {
                ...
                >
                    ...
                    <div className="mt-4">
                        ...
                        <p className="mt-1 text-sm text-foreground/50">
                            Mets à jour les informations de « {project.title} ».
                        </p>
                    </div>
                </motion.div>

                <Form
                    {...update.form({ project: project.slug })}
